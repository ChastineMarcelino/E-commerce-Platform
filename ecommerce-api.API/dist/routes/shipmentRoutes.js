 ...
 */
router.use("/api/v1/shipment", authMiddleware_1.authMiddleware, (0, baseroutes_1.createBaseRoutes)(shipmentController));
router.use("/api/v2/shipment", authMiddleware_1.authMiddleware, (0, baseroutes_1.createBaseRoutes)(shipmentController));
