 ...
 */
router.get(`/api/${apiVersionV1}/product`, authMiddleware_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
 ...
 */
router.get(`/api/${apiVersionV1}/product/:id`, authMiddleware_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
(req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const imageUrl = `${req.protocol}://${req.get("host")}/uploads/${(_a = req.file) === null || _a === void 0 ? void 0 : _a.filename}`;
 ...
 *         description: Product not found
 */
router.delete(`/api/${apiVersionV1}/product/:id`, authMiddleware_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
