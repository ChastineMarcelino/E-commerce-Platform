 ...
 */
router.get("/api/staff-members", authMiddleware_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const staff = yield user_1.User.find({
            role: { $in: ["Staff", "ADMIN"] },
            isApproved: true,
            isVerified: true,
            status: "Active"
...
router.delete("/api/users/staff/:id", authMiddleware_1.authMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const staffId = req.params.id;
        const deletedUser = yield user_1.User.findByIdAndDelete(staffId);
        if (!deletedUser) {
...
router.put("/api/users/profile/upload", authMiddleware_1.authMiddleware, upload.single("image"), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield user_1.User.findById(req.userId); // Ensure userId is set in authMiddleware
        if (!user)
