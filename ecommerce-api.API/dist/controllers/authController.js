...
class AuthController {
    ...
    register(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield newUser.save();
                yield (0, otpservice_1.sendOTP)(email, otpCode);
                res.status(201).json({
    ...
    verifyOTPHandler(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield user.save();
                // 📧 Notify admin
                yield (0, emailService_1.sendEmailNotification)(ADMIN_EMAIL, "New User Needs Approval", `User ${email} needs approval.`);
    ...
    resendOTPHandler(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield (0, otpservice_1.sendOTP)(email, otp);
                if (!result.success) {
    ...
    getPendingUsers(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const pendingUsers = yield user_1.User.find({ status: "Pending", isVerified: true });
    ...
    verifyOldPasswordBeforeReset(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const plainHints = recentPasswords
                    .map(p => { var _a; return (_a = p.plainHint) === null || _a === void 0 ? void 0 : _a.toLowerCase(); })
                    .filter(Boolean);
