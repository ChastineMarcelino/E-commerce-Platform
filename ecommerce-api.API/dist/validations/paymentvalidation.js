...
const paymentValidationSchema = joi_1.default.object({
    ...
    // - Required field
    paymentId: joi_1.default.string().max(30).required().messages({
    ...
    // - Must be a string with a max length of 30 characters
    // - Required field
    orderId: joi_1.default.string().max(30).required().messages({
    ...
    // - Required field
    paymentDate: joi_1.default.string().isoDate().required().messages({
    ...
    // - Required field
    paymentAmount: joi_1.default.number().positive().required().messages({
