...
const supplierValidationSchema = joi_1.default.object({
    // Supplier ID validation
    // - Must be a string with a max length of 30 characters
    // - Required field
    supplierId: joi_1.default.string().max(30).required().messages({
    ...
    // - Required field
    supplierName: joi_1.default.string().max(100).required().messages({
    ...
    // - Required field
    contactInfo: joi_1.default.string().max(50).required().messages({
