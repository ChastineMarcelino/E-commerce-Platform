 ...
 */
router.use("/api/v1/transaction", authMiddleware_1.authMiddleware, (0, baseroutes_1.createBaseRoutes)(transactionController));
router.use("/api/v2/transaction", authMiddleware_1.authMiddleware, (0, baseroutes_1.createBaseRoutes)(transactionController));
