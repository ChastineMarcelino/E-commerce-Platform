 ...
 */
router.use("/api/v1/suppliers", authMiddleware_1.authMiddleware, (0, baseroutes_1.createBaseRoutes)(supplierController));
router.use("/api/v2/suppliers", authMiddleware_1.authMiddleware, (0, baseroutes_1.createBaseRoutes)(supplierController));
